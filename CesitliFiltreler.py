...
#-------------------------  Mean Filtresi  ----------------------------------------
image = cv2.imread('C:/Users/MYPC/Desktop/filters/5.JPG') # reads the image
...
#)
#
#im = cv2.imread("C:/Users/MYPC/Desktop/filters/5.JPG",cv2.IMREAD_GRAYSCALE)
...
#
#images = cv2.imread('C:/Users/MYPC/Desktop/filters/5.JPG')
